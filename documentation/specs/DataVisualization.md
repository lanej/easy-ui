...
| Score explanations | `ScoreComposition` composes `ScoreSignal`, `ScoreContribution`, `ScoreResult`, and decorative `ScoreConnector` paths. Applications supply all scores, caps, relationships, decisions, and provenance. See [the score composition spec](ScoreComposition.md). |
